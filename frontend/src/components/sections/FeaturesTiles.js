...
const FeaturesTiles = ({
  ...
  const sectionHeader = {
    title: 'What we do',
    paragraph: 'Pool Detective acts as a miner on all of the mining pools we monitor. We record the traffic between the mining pool and our mining hardware. We also record data about block propagation on the peer-to-peer network, as well as validate blocks with a full node for each of the cryptocurrencies we monitor. We then look for unexpected behavior, such as:'
  };
            ...
            <div className="tiles-item reveal-from-bottom" data-reveal-delay="400">
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  ...
                  <p className="m-0 text-sm">
                    We are constantly looking for additional behavior patterns in the data we observed, testing hypotheses around potential unexpected behavior and testing the gathered data for occurences of such events.
                    </p>
                </div>
              </div>
            </div>
